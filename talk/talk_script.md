...
~9 minutes · 21 slides (+3 backup). Aligned to `Calibrate_the_Humans_v14.pptx`. For each slide:
...
### 3 · Proofreaders as agents
- Many agents observe the map and propose revisions — naive students, experienced students, experts, ML
  — each with distinct capability, cost, and scope.
- **Takeaway:** experts, students, and ML are **all agents in the loop** — it's not human-vs-machine.

### 4 · Route the work to the right agent
- Two axes — how *hard* a decision is, how much it *matters* (impact × risk). Easy+low → let the machine
...
### 5 · Prior work circled sufficiency — but didn't operationalize it
...
### 6 · But… aren't humans unnecessary? The data are too big!
...
### 7 · Two things resources buy — correction vs. validation
...
## ACT II — Can we read it? (slides 9–12, ~1.5 min)

### 9 · Can we learn a language of proofreading?
...
### 10 · Inspiration: JIGSAWS (language of surgery)
...
## ACT III — The evidence (slides 13–16, ~2 min)
...
### 14 · The language of proofreading — exploration & grammar
...
### 15 · Competence is legible per-decision, not per-person
...
### 16 · Risk is estimable, ground-truth-free
...
## ACT IV — The workforce & why it matters (slides 17–21, ~2 min)

### 17 · Who we calibrated: the workforce at APL
...
### 18 · Learning engineering: agreement-gated promotion
...
### 19 · Where this lives — students as the method
...
### 20 · Close — calibrate the people, not just the microscope
