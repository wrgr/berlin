...
plt.tight_layout(); plt.savefig(TALK/"fig_tier_auc.png",dpi=150); plt.close(); made.append("fig_tier_auc.png")
# ---- Fig 2: learned motif dictionary (no handles) ----
cent=np.array([
 [0.47,0.49,0.00,0.04,1.34,0.56,0.15,0.53],[0.17,0.82,0.00,0.01,1.83,1.08,0.00,0.28],
 [0.83,0.16,0.00,0.01,1.09,0.37,0.00,0.23],[0.00,1.00,0.00,0.00,1.06,0.36,0.00,0.00],
 [0.27,0.73,0.00,0.00,1.13,0.35,0.00,0.39],[0.62,0.36,0.00,0.02,1.90,1.30,0.00,0.48],
 [0.51,0.49,0.00,0.00,1.12,0.37,0.00,0.73],[0.16,0.58,0.21,0.05,1.77,0.93,0.00,0.65],
 [0.22,0.30,0.00,0.47,1.15,0.45,0.00,0.58],[0.27,0.53,0.00,0.20,1.15,0.44,0.00,0.65]])
...
plt.savefig(TALK/"fig_motif_dictionary.png",dpi=150); plt.close(); made.append("fig_motif_dictionary.png")
...
try:
    ...
    plt.savefig(TALK/"fig_two_task_quality.png",dpi=150); plt.close(); made.append("fig_two_task_quality.png")
...
if sa.exists() and st.exists():
    try:
        ...
        plt.tight_layout(); plt.savefig(TALK/"fig_separability.png",dpi=150); plt.close(); made.append("fig_separability.png")
