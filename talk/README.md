...
## Deck
- **`Calibrate_the_Humans_v14.pptx`** — current talk (**21 main + 3 backup** slides; "Calibrate the
  ...
  backup, condense exposition). **`berlin_deck_v11.pptx`** — prior line (`build_v6.py … build_v11.py`).
